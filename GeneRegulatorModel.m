classdef GeneRegulatorModel
    ...
    methods
        ...
        function obj = GeneRegulatorModel(varargin)
       lb=  varargin{2};
       ub= varargin{3};
          if length(varargin)==5 
            ...
            obj.qPCRData=load('qpcr_regulators_plus_Fe');
        ...
        function [params, L]=estimateParam(obj)
            ...
            [r,fval,~ ,~]=fmincon(@(param)obj.objective_func(param,obj.microArrayData.GeneData,obj.qPCRData.qpcr),obj.initialParams,[],[],[],[],obj.lb,obj.ub);
            params=r;
            L=fval;
